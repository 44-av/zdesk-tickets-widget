window.onload = function () {
  console.log("ON LOAD");
  setText("[data-p='card-title-peer']", "Child Tickets");
  ...
  ZOHODESK.get("ticket")
    .then((res) => {
      ...
      if (isChild) {
       ...
       document.querySelector(".card-title.peer").textContent = "Peer Child Tickets";
       setText("[data-p='card-title-peer']", "Peer Child Tickets"); 
        fetchParent(parentId);
        fetchChildren(parentId);
      } else if (isParent) {
        const parentId = ticket.id;
        document.querySelector(".card-title.peer").textContent = "Child Tickets";
        setText("[data-p='card-title-peer']", "Child Tickets");
        fetchChildren(parentId);
      } else {
